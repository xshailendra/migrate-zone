...
const visaCategories = [
    {
        ...
        desc: 'The H-1B visa is the most sought-after US work visa for specialty occupation workers. Employers sponsor skilled professionals in technology, engineering, medicine, and other fields.',
        icon: Briefcase,
        subsets: ['H-1B', 'H-1B1']
    },
    {
        title: 'Student Visa',
        desc: 'Study at America\'s world-leading universities. F-1 and M-1 student visas offer opportunities at academic institutions and vocational programs across the United States.',
        icon: GraduationCap,
        subsets: ['F-1', 'M-1', 'J-1']
    },
    {
        title: 'Green Card',
        desc: 'Obtain permanent residency in the United States through employment-based, family-sponsored, or diversity visa lottery programs. Live and work permanently in the USA.',
        icon: Shield,
        subsets: ['EB-1', 'EB-2', 'EB-3']
    },
    {
        title: 'Investor Visa',
        desc: 'The EB-5 Immigrant Investor Program allows foreign nationals to obtain permanent residency by making qualifying investments that create jobs in the United States.',
        icon: TrendingUp,
        subsets: ['EB-5', 'E-2']
    },
    {
        title: 'Family Visa',
        desc: 'US citizens and permanent residents can sponsor family members for immigration. Immediate relatives enjoy priority processing for faster family reunification.',
        icon: Heart,
        subsets: ['IR', 'F1', 'F2', 'F3']
    },
    {
        title: 'Tourist & Business',
        desc: 'Visit the United States for tourism, business meetings, or medical treatment. B-1/B-2 visitor visas allow temporary stays for various non-immigrant purposes.',
        icon: Plane,
        subsets: ['B-1', 'B-2', 'ESTA']
    },
];
            ...
            <section className="pt-32 pb-20 px-6 md:px-10 overflow-hidden">
                <div className="max-w-[1400px] mx-auto">
                    <motion.div className="flex justify-center mb-12" initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 0.8, scale: 1 }} transition={{ duration: 1.2, ease: "easeOut" }}>
                        <img src="/usa-dotted.png" alt="USA Map" className="w-48 md:w-72 h-auto object-contain" />
                    </motion.div>

                    <div className="flex justify-center items-end gap-3 md:gap-6 mb-16 px-4">
                        {[
                            { src: "/usa_country_1770386959388.png", w: "w-24 md:w-40", h: "h-40 md:h-64", o: "opacity-60", delay: 0.4 },
                            { src: "/usa_country_1770386959388.png", w: "w-28 md:w-48", h: "h-56 md:h-80", o: "opacity-80", delay: 0.2 },
                            { src: "/usa_country_1770386959388.png", w: "w-32 md:w-56", h: "h-72 md:h-[400px]", o: "border-4 border-[#1f406d]/10", delay: 0 },
                            { src: "/usa_country_1770386959388.png", w: "w-28 md:w-48", h: "h-56 md:h-80", o: "opacity-80", delay: 0.2 },
                            { src: "/usa_country_1770386959388.png", w: "w-24 md:w-40", h: "h-40 md:h-64", o: "opacity-60", delay: 0.4 },
                        ].map((arch, i) => (
                    ...
                    <div className="text-center relative">
                        ...
                        <motion.h1 initial={{ opacity: 0, y: 40, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }} className="text-7xl md:text-[12vw] font-[900] font-syne text-[#1f406d] leading-[0.85] tracking-tighter uppercase mb-8">
                            USA
                        </motion.h1>
                        ...
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.5 }} className="max-w-4xl mx-auto mb-16">
                            <p className="text-lg md:text-2xl font-serif italic text-[#1f406d] leading-relaxed">
                                "The United States of America stands as the land of endless opportunity, offering world-class education, innovation-driven careers, and a diverse cultural landscape for immigrants worldwide."
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="text-[#1f406d]">
                        ...
                        <div className="space-y-6 text-lg font-medium leading-relaxed opacity-80 mb-10">
                            <p>The United States is home to the world&apos;s largest economy, top-ranked universities, and unmatched career opportunities across technology, healthcare, finance, and more.</p>
                            <p>Migrate Zone Immigration consultancy provides expert guidance through America&apos;s complex immigration system. From H-1B petitions to Green Card applications, we ensure your American dream becomes reality.</p>
                        </div>
                    ...
                    <div>
                        <div className="bg-[#1f406d]/5 p-4 rounded-[40px]">
                            <img src="/usa_country_1770386959388.png" alt="USA" className="w-full grayscale hover:grayscale-0 transition-all duration-1000 rounded-[32px] shadow-2xl" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-[1400px] mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-8">
                        ...
                        <motion.p initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="text-[#1f406d]/50 text-lg max-w-md font-medium leading-relaxed">
                            Comprehensive US immigration pathways tailored to your unique profile and aspirations.
                        </motion.p>
                    </div>
