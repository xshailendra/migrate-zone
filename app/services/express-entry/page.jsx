...
const screen1 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Target Audience</span>
        </div>
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Skilled Workers</p>
                <p className="text-2xl font-black font-syne text-[#1f406d]">Specialists</p>
                <div className="mt-2 h-1 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full w-[85%] bg-[#E42E25]" />
                </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Scope</p>
                <p className="text-2xl font-black font-syne text-[#1f406d]">Global</p>
            </div>
        </div>
    </div>
);
...
const screen2 = (
    <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">CRS Ranking</p>
        <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-4">
            Invitation to <span className="text-gray-400">Apply</span>
        </h3>
        <p className="text-[11px] font-bold text-gray-400 mb-8 tracking-tight">Based on Comprehensive Ranking System</p>

        <div className="w-full space-y-3">
            {[
                { label: "Profile Created", status: "Step 1" },
                { label: "Pool Entry", status: "Step 2" },
                { label: "ITA Received", status: "Step 3" },
                { label: "Apply (60 Days)", status: "Final" }
            ].map((step, i) => (
...
const screen3 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#1f406d] mb-6">Programs</h4>
        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    ...
                    >
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            ...
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Economic Class Immigration</span>
                        </div>
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-4xl mx-auto">
                            Express Entry <span className="text-[#E42E25]">Canada</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Canada's leading immigration management system for skilled workers, permitting the country to welcome tens of thousands of immigrants every year based on their capability to succeed in Canada’s workforce.
                        </p>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">System Overview</span>
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">
                        How Express Entry <span className="text-[#E42E25]">Works</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "Who is it for?", desc: "Specialists and expert personnel worldwide who want to settle in Canada permanently. You can apply with your partner and dependent children.", icon: Users },
                            { title: "The System", desc: "Executed on January 1, 2015, it manages applications for three economic immigration programs.", icon: Shield },
                            { title: "Express Entry Pool", desc: "Candidates submit an extensive profile and enter a pool where they are ranked against others.", icon: Globe },
                            { title: "CRS Ranking", desc: "The Comprehensive Ranking System (CRS) scores candidates based on age, education, language, and experience.", icon: BarChart3 },
                            { title: "Invitation to Apply", desc: "The highest-ranking candidates are invited to apply for permanent residence through regular draws.", icon: Trophy },
                            { title: "60-Day Deadline", desc: "Once invited, you must submit a full and complete application for permanent residence within 60 days.", icon: Target },
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10 text-center">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-8 block">Immigration Streams</span>
                    <h2 className="text-5xl md:text-8xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-24">
                        ELIGIBLE <span className="text-[#E42E25]">PROGRAMS</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                        {[
                            { title: "Federal Skilled Worker", desc: "For skilled workers with foreign work experience who want to immigrate to Canada permanently.", icon: Briefcase },
                            { title: "Federal Skilled Trades", desc: "For skilled workers who become qualified in a skilled trade and want to become permanent residents.", icon: FileText },
                            { title: "Canadian Experience Class", desc: "For skilled workers who have Canadian work experience and want to become permanent residents.", icon: Globe }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
            ...
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Details about Express Entry Canada.</p>
                    </div>

                    <div className="space-y-2">
                        {[
                            { q: "What is Express Entry?", a: "Express Entry is an online system that manages applications for permanent residence from skilled workers." },
                            { q: "Who can apply?", a: "Specialists and expert personnel worldwide who meet the criteria for one of the federal economic immigration programs." },
                            { q: "Can I bring my family?", a: "Yes, applicants can apply with their partner/spouse and dependent children." },
                            { q: "What is the CRS?", a: "The Comprehensive Ranking System (CRS) is used to rank applicants in the pool based on skills, education, language ability, work experience, and other factors." },
                            { q: "What is a PNP?", a: "The Provincial Nominee Program (PNP) allows Canadian provinces and territories to nominate individuals who wish to immigrate to Canada and who are interested in settling in a particular province." }
                        ].map((faq, i) => (
