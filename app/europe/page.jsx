...
const visaCategories = [
    { title: 'EU Blue Card', desc: 'The EU Blue Card is designed for highly qualified professionals seeking employment in Europe. It provides work and residence permits across participating EU member states.', icon: Shield, subsets: ['Blue Card', 'EU Wide'] },
    { title: 'Skilled Worker', desc: 'European countries offer various skilled worker visa programs for professionals with in-demand qualifications. Each country has tailored pathways for talent acquisition.', icon: Briefcase, subsets: ['Germany', 'France', 'Netherlands'] },
    { title: 'Student Visa', desc: 'Study at prestigious European universities with rich academic traditions. Many countries offer affordable or tuition-free education with post-study work options.', icon: GraduationCap, subsets: ['Schengen', 'National'] },
    { title: 'Family Reunion', desc: 'Reunite with family members residing in Europe. EU family reunification directives provide streamlined processes for bringing loved ones together.', icon: Heart, subsets: ['Spouse', 'Dependent', 'Parent'] },
    { title: 'Business & Investor', desc: 'Establish or invest in businesses across Europe. Various countries offer entrepreneur visas, investor residency programs, and golden visa schemes.', icon: TrendingUp, subsets: ['Golden Visa', 'Entrepreneur'] },
    { title: 'Schengen Visa', desc: 'Travel freely across 27 European countries with a single Schengen visa. Ideal for tourism, business visits, and short-term stays up to 90 days.', icon: Plane, subsets: ['Type C', 'Business', 'Tourism'] },
];

const IMG = "/europe_country_1770387043225.png";
            ...
            <section className="pt-32 pb-20 px-6 md:px-10 overflow-hidden">
                <div className="max-w-[1400px] mx-auto">
                    <motion.div className="flex justify-center mb-12" initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 0.8, scale: 1 }} transition={{ duration: 1.2, ease: "easeOut" }}>
                        <img src="/europe-dotted.png" alt="Europe Map" className="w-48 md:w-72 h-auto object-contain" />
                    </motion.div>
                    ...
                    <div className="text-center relative">
                        ...
                        <motion.h1 initial={{ opacity: 0, y: 40, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }} className="text-7xl md:text-[12vw] font-[900] font-syne text-[#1f406d] leading-[0.85] tracking-tighter uppercase mb-8">EUROPE</motion.h1>
                        ...
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.5 }} className="max-w-4xl mx-auto mb-16">
                            <p className="text-lg md:text-2xl font-serif italic text-[#1f406d] leading-relaxed">{'"'}Europe offers an unparalleled blend of rich heritage, cutting-edge innovation, and diverse cultures, making it one of the most desirable destinations for work, study, and settlement.{'"'}</p>
                        </motion.div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="text-[#1f406d]">
                        ...
                        <div className="space-y-6 text-lg font-medium leading-relaxed opacity-80 mb-10">
                            <p>Europe is a continent of boundless opportunity, from Germany&apos;s engineering powerhouse to France&apos;s creative industries and the Netherlands&apos; tech ecosystem. Each country offers unique pathways for skilled immigrants.</p>
                            <p>Migrate Zone Immigration consultancy provides expert guidance across multiple European immigration systems. We help you identify the best country and visa pathway for your profile.</p>
                        </div>
                    ...
                    <div><div className="bg-[#1f406d]/5 p-4 rounded-[40px]"><img src={IMG} alt="Europe" className="w-full grayscale hover:grayscale-0 transition-all duration-1000 rounded-[32px] shadow-2xl" /></div></div>
                </div>
            </section>
            ...
            <section className="py-32 px-6 md:px-10 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-8">
                        ...
                        <motion.p initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="text-[#1f406d]/50 text-lg max-w-md font-medium leading-relaxed">Comprehensive European immigration pathways tailored to your unique profile and aspirations.</motion.p>
                    </div>
