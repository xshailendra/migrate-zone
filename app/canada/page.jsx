...
const visaCategories = [
    {
        title: 'Express Entry',
        desc: "Canada's flagship immigration system for skilled workers. Get permanent residency through Federal Skilled Worker, Canadian Experience Class, or Federal Skilled Trades programs.",
        icon: TrendingUp,
        subsets: ['FSW', 'CEC', 'FST']
    },
    {
        title: 'Provincial Nominee',
        desc: 'Each Canadian province and territory can nominate individuals who wish to immigrate and settle in that specific province based on labour market needs.',
        icon: MapPin,
        subsets: ['PNP', 'OINP', 'BCPNP']
    },
    {
        title: 'Student Visa',
        desc: 'Study at world-renowned Canadian universities and colleges. Canada offers post-graduation work permits and pathways to permanent residency for international students.',
        icon: GraduationCap,
        subsets: ['Study Permit']
    },
    {
        title: 'Work Permit',
        desc: 'Obtain authorization to work in Canada through employer-specific or open work permits. LMIA-based and LMIA-exempt options available for skilled professionals.',
        icon: Briefcase,
        subsets: ['LMIA', 'Open Work Permit']
    },
    {
        title: 'Family Sponsorship',
        desc: 'Sponsor your spouse, partner, children, parents, or grandparents for Canadian permanent residency. Reunite with your loved ones in Canada.',
        icon: Heart,
        subsets: ['Spousal', 'Parent', 'Child']
    },
    {
        title: 'Business Immigration',
        desc: 'Entrepreneurs, investors, and self-employed individuals can immigrate to Canada through dedicated business immigration streams and startup visa programs.',
        icon: Building2,
        subsets: ['Start-Up Visa', 'Self-Employed']
    },
];
        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white">
            ...
            <section className="pt-32 pb-20 px-6 md:px-10 overflow-hidden">
                <div className="max-w-[1400px] mx-auto">
                    ...
                    >
                        <img src="/canada-dotted.png" alt="Canada Map" className="w-48 md:w-72 h-auto object-contain" />
                    </motion.div>

                    <div className="flex justify-center items-end gap-3 md:gap-6 mb-16 px-4">
                        {[
                            { src: "/canada_country_1770386923730.png", w: "w-24 md:w-40", h: "h-40 md:h-64", o: "opacity-60", delay: 0.4 },
                            { src: "/canada_country_1770386923730.png", w: "w-28 md:w-48", h: "h-56 md:h-80", o: "opacity-80", delay: 0.2 },
                            { src: "/canada_country_1770386923730.png", w: "w-32 md:w-56", h: "h-72 md:h-[400px]", o: "border-4 border-[#1f406d]/10", delay: 0 },
                            { src: "/canada_country_1770386923730.png", w: "w-28 md:w-48", h: "h-56 md:h-80", o: "opacity-80", delay: 0.2 },
                            { src: "/canada_country_1770386923730.png", w: "w-24 md:w-40", h: "h-40 md:h-64", o: "opacity-60", delay: 0.4 },
                        ].map((arch, i) => (
                            <motion.div
                    ...
                    <div className="text-center relative">
                        ...
                        >
                            <p className="text-lg md:text-2xl font-serif italic text-[#1f406d] leading-relaxed">
                                "Canada is one of the most welcoming nations in the world, offering exceptional quality of life, diverse culture, and world-class opportunities for immigrants."
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="text-[#1f406d]">
                        ...
                        <div className="space-y-6 text-lg font-medium leading-relaxed opacity-80 mb-10">
                            <p>
                                Canada consistently ranks among the top countries in the world for quality of life, healthcare, and education. With its robust economy and inclusive immigration policies, Canada attracts skilled professionals from around the globe.
                            </p>
                            <p>
                                Migrate Zone Immigration consultancy helps aspirants navigate Canada&apos;s immigration pathways. We provide comprehensive support from application to settlement, ensuring a smooth transition to your new life.
                            </p>
                        </div>
                    ...
                    <div>
                        <div className="bg-[#1f406d]/5 p-4 rounded-[40px]">
                            <img
                                src="/canada_country_1770386923730.png"
                                alt="Canada"
            ...
            <section className="py-32 px-6 md:px-10 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-8">
                        ...
                        <motion.p initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="text-[#1f406d]/50 text-lg max-w-md font-medium leading-relaxed">
                            Comprehensive Canadian immigration pathways tailored to your unique profile and aspirations.
                        </motion.p>
                    </div>
                        ...
                        {visaCategories.map((visa, i) => (
                            <motion.div key={i} initial={{ opacity: 0, y: 60 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: i * 0.1, ease: [0.16, 1, 0.3, 1] }} whileHover={{ y: -8 }} className="relative group cursor-pointer">
                                <div className="relative bg-white p-10 rounded-[28px] border border-[#1f406d]/[0.06] shadow-[0_4px_40px_rgba(31,64,109,0.04)] group-hover:shadow-[0_20px_60px_rgba(31,64,109,0.12)] transition-all duration-500 flex flex-col h-full overflow-hidden">
                                    ...
                                    <h3 className="text-2xl md:text-3xl font-black font-syne uppercase tracking-tight text-[#1f406d] mb-5 leading-tight group-hover:text-[#1f406d] transition-colors">{visa.title}</h3>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-8">
                                        {visa.subsets.map(tag => (
                                            <span key={tag} className="px-3 py-1.5 bg-[#1f406d]/[0.04] text-[10px] font-black text-[#1f406d]/60 uppercase rounded-full border border-[#1f406d]/[0.06] group-hover:border-[#E42E25]/20 group-hover:bg-[#E42E25]/5 group-hover:text-[#E42E25] transition-all duration-500">{tag}</span>
                                        ))}
                                    </div>
                            ...
                            <div className="space-y-6">
                                <div className="bg-[#1f406d]/[0.03] rounded-2xl p-8 border border-[#1f406d]/[0.06] hover:border-[#E42E25]/20 transition-all duration-300">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-[#E42E25]/10 rounded-xl flex items-center justify-center shrink-0"><MapPin className="w-6 h-6 text-[#E42E25]" /></div>
                                        <div>
                                ...
                                <div className="bg-[#1f406d]/[0.03] rounded-2xl p-8 border border-[#1f406d]/[0.06] hover:border-[#E42E25]/20 transition-all duration-300">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-[#E42E25]/10 rounded-xl flex items-center justify-center shrink-0"><Globe className="w-6 h-6 text-[#E42E25]" /></div>
                                        <div>
