    ...
    <div className="p-6 h-full flex flex-col pt-12">
        <div className="flex items-center gap-2 mb-8">
            <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">
                <Rocket className="w-4 h-4 text-[#1f406d]" />
            </div>
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Startup Velocity</span>
        </div>
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">SUV Pathway</p>
                <p className="text-2xl font-black font-syne text-[#E42E25]">Direct PR</p>
                <div className="mt-2 h-1 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full w-full bg-[#1f406d]" />
                </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Global Standard</p>
                <div className="flex items-center gap-2">
                    <p className="text-2xl font-black font-syne text-[#1f406d]">Top Tier</p>
...
const screen2 = (
    <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">Federal Program</p>
        <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-4">
            FEDERAL <span className="opacity-30">BIZ</span>
        </h3>
        <p className="text-[11px] font-bold text-gray-400 mb-8 tracking-tight">Canada-Wide Immigration</p>

        <div className="w-full space-y-3">
            {[
                { label: "Business Plan", status: "Verified" },
                { label: "Funding Check", status: "Secured" },
                { label: "Entity Setup", status: "Ready" },
                { label: "PR Grant", status: "Pathway" }
            ].map((step, i) => (
...
const screen3 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#1f406d] mb-6">Key Incentives</h4>
        <div className="space-y-3">
            {[
                ...
                <div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    <TrendingUp className="w-4 h-4 text-[#E42E25]" />
...
export default function FederalBusinessImmigrationPage() {
    ...
    return (
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
            ...
            {/* ═══════════════════════════════════════════
                 HERO — Federal Business Immigration
            ═══════════════════════════════════════════ */}
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            <div className="px-1.5 py-0.5 bg-[#E42E25] rounded text-[8px] font-black text-white uppercase tracking-wider">Federal</div>
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Canada Business Visa Services</span>
                        </div>
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-5xl mx-auto">
                            Grow Your <span className="text-[#E42E25]">Business in Canada</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Expand your business or invest in Canada through the <span className="text-[#1f406d] font-bold">Federal Business Immigration Program</span>. Establish a strong presence in a welcoming ecosystem.
                        </p>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Major Opportunities</span>
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-5xl mx-auto leading-tight">
                        Top <span className="text-[#E42E25]">Business Visa</span> Pathways
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { title: "Entrepreneurs", desc: "Individuals with innovative ideas or those creating a startup through the SUV program.", icon: Rocket },
                            { title: "Investors", desc: "For those ready to make significant capital investments in the thriving Canadian market.", icon: TrendingUp },
                            { title: "Business Owners", desc: "Experienced operators looking to expand or establish new operations.", icon: Building2 },
                            { title: "Provincial Nominees", desc: "Investors nominated by provinces to run businesses in targeted regional sectors.", icon: MapPin }
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left max-w-6xl mx-auto">
                        {[
                            { title: "Business Expertise", desc: "Demonstrated experience as an entrepreneur, investor, or senior business owner." },
                            { title: "Financial Capacity", desc: "Proof of sufficient funds to establish and operate your venture in Canada." },
                            { title: "Strategic Vision", desc: "A viable business plan that aligns with federal economic and innovation priorities." },
                            { title: "Job Creation", desc: "Showing clear potential to contribute to the economy and create job opportunities." },
                            { title: "Compliance", desc: "Meeting all standard health, character, and language proficiency requirements." },
                            { title: "Specific Streams", desc: "Meeting investment thresholds or securing provincial nomination where applicable." }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                    ...
                    <div className="mt-20">
                        <Link href="/assessment" className="inline-flex items-center gap-4 text-[#1f406d] font-black uppercase tracking-widest hover:text-[#E42E25] transition-colors">
            ...
            <section ref={processSectionRef} className="py-16 md:py-20 bg-[#f8f9fb]">
                <div className="max-w-[1200px] mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Proven Flow</span>
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-8">
                            {[
                                { title: "Assessment", desc: "Free evaluation of your business profile, capital, and innovation potential." },
                                { title: "Plan Development", desc: "Crafting a world-class business proposal tailored for Federal immigration authorities." },
                                { title: "Support Securement", desc: "Obtaining required support letters from designated organizations (SUV) or provinces.", icon: FileText },
                                { title: "Visa Lodgement", desc: "Expert preparation and priority filing of your federal business immigration application." },
                                { title: "Business Setup", desc: "Guidance on establishing your headquarters and navigating the Canadian business ecosystem." },
                                { title: "PR Completion", desc: "Finalizing your Permanent Residency transition after meeting program milestones." }
                            ].map((step, i) => (
                                <div
                                    key={i}
            ...
            {/* ═══════════════════════════════════════════
                 FAQ — Federal Insights
            ═══════════════════════════════════════════ */}
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        <div className="text-left">
                            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Knowledge Center</span>
                            <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase">Federal<br />Business Q&A</h2>
                        </div>
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Detailed answers for your Canadian business questions.</p>
                    </div>

                    <div className="space-y-2">
                        {[
                            { q: "What is the minimum investment for Provincial Nominee Investor Visa?", a: "Investment amounts vary by province, but typically range from CAD 150,000 to CAD 1.5 million, depending on the province and the type of business." },
                            { q: "Can I include my family in my Business Visa application?", a: "Yes, you can include your spouse and dependent children in your application for most business visa subclasses." },
                            { q: "How long does it take to process a Business Visa for Canada?", a: "The processing time for Business Visas varies, but typically takes between 12 to 18 months, depending on the visa subclass." },
                            { q: "Do I need to have a business plan?", a: "Yes, you will need to provide a detailed business plan that outlines how your business will contribute to the Canadian economy." },
                            { q: "Can I apply for Permanent Residency on a Business Visa?", a: "Yes, both the Federal Business Immigration Program and Provincial Nominee Investor Visa can lead to Permanent Residency after meeting certain criteria." }
                        ].map((faq, i) => (
                    ...
                    >
                        <div className="flex-1">
                            <h2 className="text-5xl md:text-8xl font-[900] font-syne text-white tracking-tighter uppercase mb-10 leading-[1.1]">
                                SCALE <span className="text-[#E42E25]">GLOBAL.</span>
                            </h2>
                            <p className="text-white/40 text-lg font-medium max-w-sm">Successful entrepreneurs who moved to Canada with Migrate Zone.</p>
                        </div>
                        <div className="flex-[1.5] space-y-6">
                            {[
                                { name: "Anil Mehta", role: "Provincial Investor", text: "Thanks to Migrate Zone, I was able to invest in Canada and establish a business. The team’s expertise helped me secure my Provincial Nominee Investor Visa smoothly." },
                                { name: "Neha Kapoor", role: "Federal Entrepreneur", text: "Migrate Zone provided me with all the tools and support I needed for my Federal Business Immigration application. Now, I am living and working in Canada!" }
                            ].map((testi, i) => (
