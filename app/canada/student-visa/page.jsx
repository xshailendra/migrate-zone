    ...
    <div className="p-6 h-full flex flex-col pt-12">
        ...
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Students / Year</p>
                <p className="text-2xl font-black font-syne text-[#1f406d]">130,000+</p>
                <div className="mt-2 h-1 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full w-[85%] bg-[#E42E25]" />
                </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Permit Type</p>
...
const screen2 = (
    <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">Process</p>
        <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-4">
            Study <span className="text-gray-400">Permit</span>
        </h3>
        <p className="text-[11px] font-bold text-gray-400 mb-8 tracking-tight">Required for Education &gt; 6 Months</p>

        <div className="w-full space-y-3">
            {[
                { label: "Acceptance Letter", status: "Step 1" },
                { label: "Check Finances", status: "Step 2" },
                { label: "Submit App", status: "Step 3" },
                { label: "Permit Issued", status: "Final" }
            ].map((step, i) => (
...
export default function StudentVisaCanadaPage() {
        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    ...
                    >
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            <div className="px-1.5 py-0.5 bg-[#E42E25] rounded text-[8px] font-black text-white uppercase tracking-wider">Top Choice</div>
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Global Education</span>
                        </div>
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-4xl mx-auto">
                            Study in <span className="text-[#E42E25]">Canada</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Canada continues to fascinate a stable capacity of students from India. Get admission to Top Universities and secure your future with a Canadian Study Permit.
                        </p>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Visa Details</span>
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">
                        About <span className="text-[#E42E25]">Study Permit</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "What is it?", desc: "A document issued by the Canadian government that allows foreign nationals to study at DLIs in Canada.", icon: FileText },
                            { title: "Who Needs It?", desc: "Required for most foreign nationals who want to study in Canada for more than 6 months.", icon: GraduationCap },
                            { title: "Validity", desc: "Usually valid for the length of your study program, plus an extra 90 days to prepare to leave or extend stay.", icon: BookOpen },
                            { title: "Working", desc: "You may be able to work on-campus or off-campus if you meet specific criteria listed on your permit.", icon: DollarSign },
                            { title: "Port of Entry", desc: "You receive the actual study permit when you arrive in Canada. You must present your Letter of Introduction.", icon: Plane },
                            { title: "Responsibilities", desc: "You must make progress towards completing your program and respect the conditions of your permit.", icon: Shield },
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
            ...
            {/* ═══════════════════════════════════════════
                 ELIGIBILITY — Three Core Pillars
            ═══════════════════════════════════════════ */}
            <section className="py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10 text-center">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-8 block">Requirements</span>
                    <h2 className="text-5xl md:text-8xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-24">
                        ELIGIBILITY <span className="text-[#E42E25]">CRITERIA</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                        {[
                            { title: "Designated Institute", desc: "You must be enrolled at a Designated Learning Institution (DLI) in Canada.", icon: School },
                            { title: "Proof of Funds", desc: "Prove you have enough money to pay for tuition fees, living expenses, and return transportation.", icon: DollarSign },
                            { title: "Clean Record", desc: "You must obey the law, have no criminal record, and be in good health (medical exam may be required).", icon: Shield }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
            ...
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Everything you need to know about Canada Student Visa.</p>
                    </div>

                    <div className="space-y-2">
                        {[
                            { q: "What is a DLI?", a: "A Designated Learning Institution (DLI) is a school approved by a provincial or territorial government to host international students." },
                            { q: "Can I bring my family?", a: "Yes, you may be able to bring your spouse or common-law partner, and dependent children, to Canada with you." },
                            { q: "Can I work while studying?", a: "You may work on-campus or off-campus without a work permit if you meet specific criteria listed on your study permit." },
                            { q: "What happens after graduation?", a: "You may be eligible for a Post-Graduation Work Permit (PGWP) to work in Canada after you complete your studies." },
                            { q: "Why do visas get rejected?", a: "Common reasons include insufficient financial proof, lack of strong ties to home country, or an unclear study plan." }
                        ].map((faq, i) => (
