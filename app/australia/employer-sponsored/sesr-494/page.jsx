...
const screen1 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Regional Experts</span>
        </div>
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Settled Families</p>
                <p className="text-2xl font-black font-syne text-[#1f406d]">2,200+</p>
                <div className="mt-2 h-1 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full w-[92%] bg-[#E42E25]" />
                </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Regional Experience</p>
...
const screen2 = (
    <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">Regional Hub</p>
        <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-4">
            PR <span className="opacity-30">TRACK</span>
        </h3>
        <p className="text-[11px] font-bold text-gray-400 mb-8 tracking-tight">Pathway to Permanent Residency</p>

        <div className="w-full space-y-3">
            {[
                { label: "Profile Evaluation", status: "Completed" },
                { label: "Employer Matching", status: "In Progress" },
                { label: "Nomination Support", status: "Pending" },
...
const screen3 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#1f406d] mb-6">494 Requirements</h4>
        <div className="space-y-3">
            {[
                "Under 45 Years Old",
                "Regional Skilled List",
...
export default function SESR494Page() {
    ...
    useGSAP(() => {
        ...
        processItemsRef.current.forEach((item, index) => {
            ...
            // Animate the number circle smoothly
    ...
    return (
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            ...
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Skilled Employer Sponsored Visa</span>
                        </div>
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-4xl mx-auto">
                            The Gateway to <span className="text-[#E42E25]">Regional Australia</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Work, Live & Settle in Regional Australia with the <span className="text-[#1f406d] font-bold">Subclass 494 Visa</span>. Your direct pathway to Permanent Residency after 3 years.
                        </p>
            ...
            {/* ═══════════════════════════════════════════
                 BENEFITS — Why Regional
            ═══════════════════════════════════════════ */}
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Opportunity Analysis</span>
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">
                        Why Professionals Choose <span className="text-[#E42E25]">Subclass 494</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "5-Year Residency", desc: "Live and work in designated regional areas of Australia for up to 5 years.", icon: Shield },
                            { title: "Medicare Access", desc: "Enjoy full access to Australia's public healthcare system (Medicare) for your family.", icon: CheckCircle2 },
                            { title: "Fast-Track PR", desc: "Eligible to apply for Permanent Residency (Subclass 191) after just 3 years.", icon: Briefcase }
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-5xl mx-auto">
                        {[
                            { title: "Employer Sponsored", desc: "For applicants with a nomination by an approved regional Australian employer.", icon: ArrowRight },
                            { title: "Labour Agreement", desc: "For workers under a Labour Agreement negotiated between the employer and the government.", icon: FileText }
                        ].map((stream, i) => (
                            <motion.div
                                key={i}
                ...
                <div className="max-w-[1200px] mx-auto px-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-8">
                            {[
                                { title: "Profile Evaluation", desc: "We start with a thorough assessment of your eligibility and regional job prospects." },
                                { title: "Employer Matching", desc: "Our network helps find regional Australian employers ready to sponsor skilled talent." },
                                { title: "Skills Assessment", desc: "Guidance on obtaining a mandatory skills assessment for your nominated occupation." },
                                { title: "Nomination Support", desc: "Managing the complex nomination process with your regional employer." },
                                { title: "Visa Filing", desc: "Complete handling of your 494 visa application with 100% transparency." },
                                { title: "PR Transition", desc: "Planning your path to Permanent Residency (Subclass 191) from day one." }
                            ].map((step, i) => (
                                <div
                                    key={i}
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        <div className="number-circle w-20 h-20 bg-white rounded-3xl border-2 border-[#1f406d]/5 flex items-center justify-center text-2xl font-black font-syne text-[#E42E25] shadow-xl shadow-black/5 group-hover:bg-[#E42E25] group-hover:text-white transition-all">
                                            0{i + 1}
                                        </div>
                                    </div>
            ...
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Detailed answers for your regional migration queries.</p>
                    </div>

                    <div className="space-y-2">
                        {[
                            { q: "Can I apply for PR after getting a 494 visa?", a: "Yes. After 3 years of holding the 494 visa, if income and residency criteria are met, you can apply for Subclass 191 Permanent Residency." },
                            { q: "Is this visa only for rural areas?", a: "Not exactly. It’s for designated regional areas, which include major cities like Adelaide, Perth, Gold Coast, Canberra, and others outside Sydney, Melbourne, and Brisbane." },
                            { q: "Can I include my family in this visa?", a: "Absolutely. You can include your spouse and dependent children, and they can work and study in Australia." },
                            { q: "What happens if I lose my job while on a 494 visa?", a: "You’ll need to find another approved sponsor within 90 days. We help with transitions and finding a new employer if needed." },
                            { q: "What is the processing time?", a: "Typically between 4 to 9 months, depending on your profile and employer readiness." }
                        ].map((faq, i) => (
                    ...
                    <div className="flex flex-col md:flex-row gap-20 items-center">
                        <div className="flex-1">
                            ...
                            <h2 className="text-5xl md:text-7xl font-[900] font-syne text-white tracking-tighter uppercase mb-10 leading-none">
                                What Our<br />Clients <span className="text-[#E42E25]">Say</span>
                            </h2>
                        </div>
                        <div className="flex-[1.5] grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[
                                { name: "Yash", role: "494 Visa Holder", text: "Sagar Sir and the Migrate Zone team helped me move to regional Australia through a 494 visa. Their step-by-step guidance made the process stress-free." },
                                { name: "Rinkal Prajapati", role: "Victoria", text: "After struggling on my own, I reached out to Migrate Zone. They found an employer sponsor for me in Victoria and helped me get my visa. Truly thankful!" }
                            ].map((testi, i) => (
