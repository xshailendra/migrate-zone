    ...
    <div className="p-6 h-full flex flex-col pt-12">
        <div className="flex items-center gap-2 mb-8">
            <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">
                <Compass className="w-4 h-4 text-[#1f406d]" />
            </div>
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Explore Australia</span>
        </div>
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Visa Duration</p>
                <p className="text-2xl font-black font-syne text-[#1f406d]">Up to 12m</p>
                <div className="mt-2 h-1 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full w-3/4 bg-[#E42E25]" />
                </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Process Time</p>
                <p className="text-2xl font-black font-syne text-[#E42E25]">15-30 Days</p>
            </div>
        </div>
    </div>
);
...
const screen2 = (
    <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">Visitor Pass</p>
        <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-4">
            600 <span className="opacity-30">VISA</span>
        </h3>
        <p className="text-[11px] font-bold text-gray-400 mb-8 tracking-tight">Tourism | Business | Family</p>

        <div className="w-full space-y-3">
            {[
                { label: "Tourist Stream", status: "Available" },
                { label: "Business Stream", status: "Available" },
                { label: "Family Stream", status: "Available" },
                { label: "Fast-Track", status: "Optional" }
            ].map((step, i) => (
...
const screen3 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#1f406d] mb-6">Key Requirements</h4>
        ...
        <div className="mt-auto bg-[#1f406d] p-4 rounded-2xl text-center cursor-pointer hover:bg-[#E42E25] transition-colors">
            <span className="text-[10px] font-black text-white uppercase tracking-widest">Apply Today</span>
        </div>
    </div>
);
...
export default function VisitorVisa600Page() {
        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            <div className="px-1.5 py-0.5 bg-[#E42E25] rounded text-[8px] font-black text-white uppercase tracking-wider">Tourism</div>
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Australia Visitor Visa — Subclass 600</span>
                        </div>
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-4xl mx-auto">
                            Experience the <span className="text-[#E42E25]">Australian Spirit</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Travel for tourism, business meetings, or family visits with the <span className="text-[#1f406d] font-bold">Subclass 600 Visitor Visa</span>. Fast, reliable, and hassle-free processing.
                        </p>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">
                        Perfect for Your <span className="text-[#E42E25]">Short-Term Stay</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "Longer Stays", desc: "Stay in Australia for up to 3, 6, or 12 months depending on your requirement.", icon: Camera },
                            { title: "Multiple Entries", desc: "Enjoy the flexibility of multiple entry options to visit family or attend business events.", icon: Globe },
                            { title: "Fast Processing", desc: "Quick turnaround times with expert filing to ensure your travel plans stay on track.", icon: Zap }
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10 text-center">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-8 block">Stream Options</span>
                    <h2 className="text-5xl md:text-8xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-24">
                        VERSATILE <span className="text-[#E42E25]">VISITOR</span> STREAMS
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-6xl mx-auto">
                        {[
                            { title: "Tourist Stream", desc: "Designed for visitors travelling for tourism or to see family and friends.", icon: Camera },
                            { title: "Business Visitor", desc: "Perfect for attending conferences, seminars, meetings, or exploring investments.", icon: Briefcase },
                            { title: "Sponsored Family", desc: "When an Australian citizen or PR relative sponsors your visit.", icon: Users }
                        ].map((stream, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
                            ...
                            >
                                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-8 shadow-sm group-hover:bg-[#1f406d] transition-all">
                                    <stream.icon className="w-6 h-6 text-[#E42E25] group-hover:text-white transition-all" />
                                </div>
                                <h3 className="text-2xl font-black font-syne text-[#1f406d] uppercase mb-4 tracking-tight">{stream.title}</h3>
                                <p className="text-[#1f406d]/60 font-medium leading-relaxed">{stream.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section ref={processSectionRef} className="py-16 md:py-20 bg-[#f8f9fb]">
                <div className="max-w-[1200px] mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Hassle-Free Process</span>
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-8">
                            {[
                                { title: "Profile Review", desc: "We evaluate your travel intent and financial status to ensure maximum success chances." },
                                { title: "Document Collection", desc: "Complete assistance in gathering bank statements, invitation letters, and cover letters." },
                                { title: "Form Preparation", desc: "Precise filling of Subclass 600 application forms to avoid any errors or delays." },
                                { title: "Application Filing", desc: "Submission of your application to the Australian Department of Home Affairs." },
                                { title: "Outcome Follow-up", desc: "Monitoring your application status and guiding you through any additional requests." }
                            ].map((step, i) => (
                                <div
                                    key={i}
            ...
            {/* ═══════════════════════════════════════════
                 FAQ — Visitor Insights
            ═══════════════════════════════════════════ */}
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        <div className="text-left">
                            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">Travel Specialist</span>
                            <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase">Common<br />Travel Queries</h2>
                        </div>
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Everything you need to know about visiting Australia.</p>
                    </div>

                    <div className="space-y-2">
                        {[
                            { q: "How long can I stay on a Visitor Visa?", a: "You may stay up to 3, 6, or 12 months, depending on your application and reason for travel." },
                            { q: "Can I work on a Visitor Visa?", a: "No. The Subclass 600 visa does not permit work. You may attend business meetings but not take up employment." },
                            { q: "Can I extend my visa while in Australia?", a: "In limited cases, you may apply for a further stay. We can help assess your eligibility." },
                            { q: "Do I need to provide proof of funds?", a: "Yes. You must show financial capacity to cover your travel, stay, and return expenses." },
                            { q: "How long does it take to process the 600 visa?", a: "Processing time typically ranges from 15 to 30 working days, but can vary based on individual circumstances." }
                        ].map((faq, i) => (
            ...
            <section className="py-24 bg-[#1f406d] relative overflow-hidden">
                <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="flex flex-col md:flex-row gap-20 items-center text-center md:text-left"
                    >
                        <div className="flex-1">
                            <div className="w-20 h-20 bg-[#E42E25] rounded-3xl flex items-center justify-center mb-10 shadow-2xl shadow-black/20 mx-auto md:mx-0">
                                <MessageSquare className="w-8 h-8 text-white" />
                            </div>
                            <h2 className="text-5xl md:text-7xl font-[900] font-syne text-white tracking-tighter uppercase mb-10 leading-none">
                                Traveler<br />Success <span className="text-[#E42E25]">Stories</span>
                            </h2>
                        </div>
                        <div className="flex-[1.5]">
                            <div className="p-12 bg-white/5 border border-white/10 rounded-[3rem] backdrop-blur-sm">
                                <p className="text-white/90 text-2xl font-medium italic mb-10 leading-relaxed">
                                    "Under the expert guidance of Migrate Zone, I finally got my Business Visitor Visa! Their professionalism and care made the journey entirely smooth."
                                </p>
                                <div>
                                    <p className="text-white text-xl font-black font-syne uppercase tracking-widest">Rinkal Prajapati</p>
                                    <p className="text-[#E42E25] text-sm font-bold uppercase tracking-widest mt-2">Business Visitor</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
