...
const screen1 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Nominated PR</span>
        </div>
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">State Selection</p>
                <div className="flex flex-wrap gap-1 mt-2">
                    {["VIC", "NSW", "QLD", "WA", "SA"].map((s, i) => (
                        <span key={i} className="px-2 py-0.5 bg-[#1f406d]/10 rounded text-[8px] font-black font-syne text-[#1f406d]">{s}</span>
                    ))}
                </div>
            </div>
            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Points Booster</p>
                <p className="text-2xl font-black font-syne text-[#E42E25]">+5 Pts</p>
                <p className="text-[8px] font-bold text-gray-400 mt-1 uppercase tracking-widest">State Nomination Bonus</p>
            </div>
        </div>
    </div>
);
...
const screen2 = (
    <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">State Nomination</p>
        <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-4">
            PR <span className="opacity-30">VISA</span>
        </h3>
        <p className="text-[11px] font-bold text-gray-400 mb-8 tracking-tight">Support from States</p>

        <div className="w-full space-y-3">
            {[
                { label: "Nomination (ROI)", status: "Completed" },
                { label: "Skill Assessment", status: "In Progress" },
                { label: "ITA Round", status: "Pending" },
...
const screen3 = (
    <div className="p-6 h-full flex flex-col pt-12">
        <h4 className="text-xs font-black uppercase tracking-[0.2em] text-[#1f406d] mb-6">190 Benefits</h4>
...
export default function SkilledNominated190Page() {
        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            <div className="px-1.5 py-0.5 bg-[#E42E25] rounded text-[8px] font-black text-white uppercase tracking-wider">Nominated</div>
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Skilled Migration — Subclass 190</span>
                        </div>
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-4xl mx-auto">
                            The Priority of <span className="text-[#E42E25]">State Nomination</span>
                        </h1>

                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Migrate to Australia with the <span className="text-[#1f406d] font-bold">Subclass 190 Visa</span>. Gain permanent residency with support from Australian states and territories.
                        </p>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-4 block">State Advantages</span>
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">
                        Why Professionals Seek <span className="text-[#E42E25]">Subclass 190</span>
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "+5 Points Bonus", desc: "Gain an immediate 5-point boost to your SkillSelect score through state nomination.", icon: Zap },
                            { title: "Priority Processing", desc: "Benefit from faster processing times and priority assessment centers.", icon: Shield },
                            { title: "Permanent Residency", desc: "Enjoy full PR status from day one, allowing you to settle with your family.", icon: Briefcase }
                        ].map((card, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 md:py-40 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10 text-center">
                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#E42E25] mb-8 block">Regional Coverage</span>
                    <h2 className="text-5xl md:text-8xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-24">
                        NOMINATING <span className="text-[#E42E25]">STATES</span>
                    </h2>

                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 text-left">
                        {[
                            { name: "Victoria", desc: "Priority for Health & Tech." },
                            { name: "NSW", desc: "Top choice for Business Analysts." },
                            { name: "Queensland", desc: "Gateway to Engineering roles." },
                            { name: "South Australia", desc: "Great for skilled trades." },
                            { name: "Western Australia", desc: "Resource & Mining hub." },
                            { name: "Tasmania", desc: "Excellent for education." },
                            { name: "Northern Territory", desc: "Rich in community service." },
                            { name: "ACT", desc: "The government services center." }
                        ].map((state, i) => (
                            <motion.div
                                key={i}
                                ...
                                className="group p-8 bg-[#f8f9fb] border border-[#1f406d]/5 rounded-[2rem] hover:bg-white hover:shadow-2xl hover:shadow-[#1f406d]/5 transition-all duration-500"
                            >
                                <h3 className="text-base font-black font-syne text-[#1f406d] uppercase tracking-tighter mb-2">{state.name}</h3>
                                <p className="text-[#1f406d]/60 text-xs font-medium">{state.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-[1200px] mx-auto px-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-8">
                            {[
                                { title: "Eligibility Assessment", desc: "Verification of your skills and points to ensure state nomination success." },
                                { title: "Skill Assessment", desc: "Hands-on support to get a positive outcome from your assessment authority." },
                                { title: "EOI Lodgement", desc: "Strategic submission of your EOI through the SkillSelect system." },
                                { title: "State Nomination", desc: "Expert handling of your application to the chosen Australian state or territory." },
                                { title: "ITA & Visa Filing", desc: "Lodging your subclass 190 visa application once the invitation is received." },
                                { title: "Visa Grant", desc: "Final clearance and move to Australia with comprehensive settlement support." }
                            ].map((step, i) => (
                                <div
                                    key={i}
            ...
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Everything you need to know about state sponsorship.</p>
                    </div>

                    <div className="space-y-2">
                        {[
                            { q: "Is the 190 visa a permanent visa?", a: "Yes, the 190 visa grants immediate permanent residency in Australia." },
                            { q: "Do I need a job offer to apply for a 190 visa?", a: "No. A state nomination is required, but not a job offer. However, having one may increase your chances of nomination." },
                            { q: "What’s the benefit of state nomination?", a: "You receive 5 additional points for your EOI and priority processing from the Department of Home Affairs." },
                            { q: "Can I move to another state after getting my visa?", a: "You're expected to live and work in your nominating state for at least 2 years, but it is a legal PR visa." },
                            { q: "How long does the process take?", a: "On average, the process takes 6 to 12 months, depending on your occupation, profile, and state timelines." }
                        ].map((faq, i) => (
                ...
                <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex-[1.5] grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[
                                { name: "Yash", role: "South Australia", text: "I was stuck with low points, but Migrate Zone helped me secure a state nomination from South Australia. Now I hold a PR!" },
                                { name: "Rinkal Prajapati", role: "190 Visa Holder", text: "Migrate Zone guided me perfectly—from EOI to nomination to visa grant. Their support and transparency were top-class." }
                            ].map((testi, i) => (
