        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            <div className="px-1.5 py-0.5 bg-[#E42E25] rounded text-[8px] font-black text-white uppercase tracking-wider">Subclass 190</div>
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">State Nominated Visa</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-5xl mx-auto">
                            Nominated for <span className="text-[#E42E25]">Success</span>
                        </h1>
                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            A permanent visa requiring nomination by an Australian State or Territory government. Gain extra points and state support.
                        </p>
                        ...
                        <div className="flex justify-center items-end gap-0 md:gap-8 absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-20">
                            <IPhoneFrame innerRef={leftPhoneRef} className="hidden md:block shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
                                <div className="p-6 h-full flex flex-col pt-12">
                                    <div className="flex items-center gap-2 mb-8"><div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center"><Building className="w-4 h-4 text-[#1f406d]" /></div><span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Nomination</span></div>
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 mb-4"><p className="text-[10px] font-bold text-gray-400 uppercase mb-1">State Points</p><p className="text-2xl font-black font-syne text-[#1f406d]">+5 Points</p></div>
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100"><p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Selection</p><p className="text-xl font-black font-syne text-[#1f406d]">Priority Lists</p></div>
                                </div>
                            </IPhoneFrame>
                            ...
                            <IPhoneFrame innerRef={rightPhoneRef} className="hidden md:block shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
                                <div className="p-6 h-full flex flex-col pt-12">
                                    ...
                                    <div className="space-y-3">{["Live in Nominating State", "Work in Nominating State", "2 Years Commitment", "Permanent Status"].map((r, i) => (<div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl"><CheckCircle2 className="w-4 h-4 text-[#E42E25]" /><span className="text-[11px] font-bold text-[#1f406d]/60">{r}</span></div>))}</div>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">Why Choose <span className="text-[#E42E25]">Visa 190</span>?</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "Point Boost", desc: "Receive an automatic 5 points for state nomination to help reach the pass mark.", icon: Plus },
                            { title: "Permanent", desc: "Permanent residency with access to Medicare and social security benefits.", icon: Shield },
                            { title: "Expanded List", desc: "Access a wider range of occupations on state-specific lists.", icon: Briefcase }
                        ].map((card, i) => (
            ...
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Details about the Skilled Nominated Visa 190.</p>
                    </div>
                    <div className="space-y-2">
                        {[
                            { q: "Do I have to live in the state?", a: "Yes, you generally must agree to live and work in the nominating state or territory for at least 2 years after the visa grant." },
                            { q: "Does the state find me a job?", a: "No, state nomination does not guarantee employment. It is your responsibility to find work." },
                            { q: "Is this a permanent visa?", a: "Yes, the Skilled Nominated visa (subclass 190) is a permanent visa." },
                            { q: "Can I move interstate later?", a: "After fulfilling your 2-year commitment to the nominating state, you are generally free to live and work anywhere in Australia." },
                            { q: "How many points do I need?", a: "You need 65 points including the 5 points from state nomination." }
