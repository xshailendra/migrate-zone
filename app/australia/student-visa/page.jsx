...
import { ArrowRight, CheckCircle2, Minus, Plus, GraduationCap, DollarSign, BookOpen, Clock, Briefcase } from 'lucide-react';
        ...
        <main className="min-h-screen bg-white selection:bg-[#E42E25] selection:text-white relative" ref={containerRef}>
                ...
                <div className="max-w-[1400px] mx-auto text-center relative z-10 mb-20 md:mb-32">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1f406d]/5 rounded-full border border-[#1f406d]/10 mb-8">
                            <div className="px-1.5 py-0.5 bg-[#E42E25] rounded text-[8px] font-black text-white uppercase tracking-wider">Subclass 500</div>
                            <span className="text-[10px] font-black text-[#1f406d] uppercase tracking-widest">Student Visa</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[900] font-syne text-[#1f406d] leading-[1.1] tracking-tighter mb-8 max-w-5xl mx-auto">
                            World-Class <span className="text-[#E42E25]">Education</span>
                        </h1>
                        <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
                            Study full-time in a recognized education institution in Australia. Enhance your career prospects and experience the Australian lifestyle.
                        </p>
                        ...
                        <div className="flex justify-center items-end gap-0 md:gap-8 absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-20">
                            <IPhoneFrame innerRef={leftPhoneRef} className="hidden md:block shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
                                <div className="p-6 h-full flex flex-col pt-12">
                                    <div className="flex items-center gap-2 mb-8"><div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center"><GraduationCap className="w-4 h-4 text-[#1f406d]" /></div><span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Course</span></div>
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 mb-4"><p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Duration</p><p className="text-2xl font-black font-syne text-[#1f406d]">Up to 5 Yrs</p></div>
                                    <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100"><p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Work Rights</p><p className="text-2xl font-black font-syne text-[#1f406d]">Fortnightly</p></div>
                                </div>
                            </IPhoneFrame>
                            <IPhoneFrame innerRef={centerPhoneRef} className="z-10 shadow-[0_40px_100px_rgba(0,0,0,0.1)]">
                                <div className="p-6 h-full flex flex-col pt-12 text-center items-center">
                                    <div className="w-14 h-14 bg-[#1f406d]/5 rounded-2xl flex items-center justify-center mb-6"><div className="w-10 h-10 bg-[#1f406d] rounded-xl flex items-center justify-center"><BookOpen className="w-5 h-5 text-white" /></div></div>
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E42E25] mb-2">Academic</p>
                                    <h3 className="text-2xl font-[900] font-syne text-[#1f406d] uppercase tracking-tighter leading-tight mb-8">Study <span className="text-gray-400">Here</span></h3>
                                    <div className="w-full space-y-3">
                                        {[{ l: "Enrollment (CoE)", s: "Step 1" }, { l: "Visa Application", s: "Step 2" }, { l: "Health & Character", s: "Step 3" }, { l: "Start Course", s: "Goal" }].map((s, i) => (<div key={i} className="flex items-center gap-3 p-3 bg-[#f8f9fb] rounded-2xl"><div className={`w-2 h-2 rounded-full ${i === 3 ? 'bg-green-500' : 'bg-[#1f406d]'}`} /><div className="text-left"><p className="text-[11px] font-black text-[#1f406d]">{s.l}</p><p className="text-[8px] font-bold text-gray-400 uppercase tracking-widest">{s.s}</p></div></div>))}
                                    </div>
                                </div>
                            </IPhoneFrame>
                            <IPhoneFrame innerRef={rightPhoneRef} className="hidden md:block shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
                                <div className="p-6 h-full flex flex-col pt-12">
                                    ...
                                    <div className="space-y-3">{["Confirmation of Enroll", "Health Insurance (OSHC)", "English Proficiency", "Genuine Student"].map((r, i) => (<div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl"><CheckCircle2 className="w-4 h-4 text-[#E42E25]" /><span className="text-[11px] font-bold text-[#1f406d]/60">{r}</span></div>))}</div>
                                    <div className="mt-auto bg-[#1f406d] p-4 rounded-2xl text-center"><span className="text-[10px] font-black text-white uppercase tracking-widest">Enroll Now</span></div>
                                </div>
                            </IPhoneFrame>
                        </div>
                    </div>
            ...
            <section className="py-12 md:py-24 px-6 md:px-10 bg-white">
                <div className="max-w-[1400px] mx-auto text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-6xl font-[900] font-syne text-[#1f406d] tracking-tighter uppercase mb-20 max-w-4xl mx-auto leading-tight">Why Choose <span className="text-[#E42E25]">Student Visa</span>?</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "World Class", desc: "Access some of the best universities and colleges in the world.", icon: GraduationCap },
                            { title: "Work Rights", desc: "Work part-time (usually 48 hours per fortnight) while studying.", icon: DollarSign },
                            { title: "Post-Study Work", desc: "Eligible for Post-Study Work stream visa (Subclass 485) after graduation.", icon: Briefcase }
                        ].map((card, i) => (
            ...
            <section className="py-24 md:py-48 bg-white relative">
                <div className="max-w-[1000px] mx-auto px-6">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        <p className="text-[#1f406d]/40 text-lg font-medium max-w-sm mb-2">Details about the Student Visa 500.</p>
                    </div>
                    <div className="space-y-2">
                        {[
                            { q: "Can I bring my family?", a: "Yes, you can include your partner and dependent children in your student visa application." },
                            { q: "How much money do I need?", a: "You must prove you have enough money to pay for your stay in Australia. This includes travel, course fees, and living costs." },
                            { q: "Can I work full time?", a: "Generally, no. You are limited to 48 hours per fortnight when your course is in session, but you can work unlimited hours during scheduled course breaks." },
                            { q: "What is GTE/GST?", a: "The Genuine Student Test (GST) ensures that the visa applicant intends to stay in Australia temporarily for study purposes." },
                            { q: "Do I need health insurance?", a: "Yes, you must maintain Overseas Student Health Cover (OSHC) for the duration of your stay." }
