...
const visaCategories = [
    {
        ...
        desc: 'New Zealand\'s Skilled Migrant Category is a points-based residence visa for skilled workers who can contribute to the country\'s economic growth and development.',
        icon: TrendingUp,
        subsets: ['SMC', 'Points Based']
    },
    {
        title: 'Work Visa',
        desc: 'Various work visa options allow you to live and work in New Zealand temporarily. Essential Skills, Specific Purpose, and Accredited Employer work visas are popular pathways.',
        icon: Briefcase,
        subsets: ['Essential Skills', 'AEWV']
    },
    {
        title: 'Student Visa',
        desc: 'Study at New Zealand\'s world-class institutions. Student visas offer pathways to post-study work visas and eventual residence in this beautiful country.',
        icon: GraduationCap,
        subsets: ['Student Visa']
    },
    {
        title: 'Family Visa',
        desc: 'Reunite with your family in New Zealand through partnership, parent, or dependent child visa categories. Build your new life together in Aotearoa.',
        icon: Heart,
        subsets: ['Partnership', 'Parent', 'Child']
    },
    {
        title: 'Visitor Visa',
        desc: 'Explore New Zealand\'s stunning landscapes and vibrant cities. Visitor visas are available for tourism, business visits, and short-term activities.',
        icon: Plane,
        subsets: ['Tourism', 'Business']
    },
    {
        title: 'Business Visa',
        desc: 'Invest and establish your business in New Zealand. Entrepreneur and investor visa categories provide opportunities for experienced business professionals.',
        icon: Building2,
        subsets: ['Entrepreneur', 'Investor']
    },
];
            ...
            <section className="pt-32 pb-20 px-6 md:px-10 overflow-hidden">
                <div className="max-w-[1400px] mx-auto">
                    ...
                    <div className="flex justify-center items-end gap-3 md:gap-6 mb-16 px-4">
                        {[
                            { src: "/newzealand_country_1770386941714.png", w: "w-24 md:w-40", h: "h-40 md:h-64", o: "opacity-60", delay: 0.4 },
                            { src: "/newzealand_country_1770386941714.png", w: "w-28 md:w-48", h: "h-56 md:h-80", o: "opacity-80", delay: 0.2 },
                            { src: "/newzealand_country_1770386941714.png", w: "w-32 md:w-56", h: "h-72 md:h-[400px]", o: "border-4 border-[#1f406d]/10", delay: 0 },
                            { src: "/newzealand_country_1770386941714.png", w: "w-28 md:w-48", h: "h-56 md:h-80", o: "opacity-80", delay: 0.2 },
                            { src: "/newzealand_country_1770386941714.png", w: "w-24 md:w-40", h: "h-40 md:h-64", o: "opacity-60", delay: 0.4 },
                        ].map((arch, i) => (
                    ...
                    <div className="text-center relative">
                        ...
                        <motion.h1 initial={{ opacity: 0, y: 40, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }} className="text-6xl md:text-[10vw] font-[900] font-syne text-[#1f406d] leading-[0.85] tracking-tighter uppercase mb-8">
                            NEW ZEALAND
                        </motion.h1>
                        ...
                        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.5 }} className="max-w-4xl mx-auto mb-16">
                            <p className="text-lg md:text-2xl font-serif italic text-[#1f406d] leading-relaxed">
                                "New Zealand offers a unique blend of breathtaking natural beauty, high quality of life, and welcoming immigration policies that make it an ideal destination for migrants worldwide."
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="text-[#1f406d]">
                        ...
                        <div className="space-y-6 text-lg font-medium leading-relaxed opacity-80 mb-10">
                            <p>New Zealand is renowned for its exceptional work-life balance, clean environment, and progressive society. The country offers numerous opportunities for skilled professionals across various industries.</p>
                            <p>Migrate Zone Immigration consultancy guides you through New Zealand&apos;s immigration process with expertise and dedication. From visa applications to settlement support, we ensure your journey is seamless.</p>
                        </div>
                    ...
                    <div>
                        <div className="bg-[#1f406d]/5 p-4 rounded-[40px]">
                            <img src="/newzealand_country_1770386941714.png" alt="New Zealand" className="w-full grayscale hover:grayscale-0 transition-all duration-1000 rounded-[32px] shadow-2xl" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-[1400px] mx-auto relative z-10">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-8">
                        ...
                        <motion.p initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="text-[#1f406d]/50 text-lg max-w-md font-medium leading-relaxed">
                            Comprehensive New Zealand visa pathways tailored to your unique profile and aspirations.
                        </motion.p>
                    </div>
